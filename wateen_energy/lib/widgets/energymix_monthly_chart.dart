...
class EnergyMixMonthlyChart extends StatefulWidget {
  final List<SolarData> chartData;

  EnergyMixMonthlyChart(this.chartData);

  @override
  State<EnergyMixMonthlyChart> createState() => _EnergyMixMonthlyChartState();
}

class _EnergyMixMonthlyChartState extends State<EnergyMixMonthlyChart> {
